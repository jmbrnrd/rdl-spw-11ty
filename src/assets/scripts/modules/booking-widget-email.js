...
export default function (config){
  ...
  bkgForm.innerHTML =
      ...
      <select id="selectCovers"
       ...
       <button class="btn" aria-label="bookings.email.submit.aria">Booking Request</button>`;
        ...
        emailRequestSummary.innerHTML =
          `<form id="emailRequestForm">
            ...
            <input type="hidden" name="sender" value="${config.sender}">
                ...
                <h2>Please enter your contact details below:</h2>
                <!-- Name -->
                ...
                <p>Please note: booking requests are subject to availability and are not confirmed until you have been contacted by <strong>${config.name}</strong>.</p>
                <!-- Actions -->
                <div class="modal-actions">
                  <button id="btnCancel" type="button" class="btn-cancel">CANCEL</button>
                  <button id="btnSubmit" type="submit" class="btn">SEND REQUEST</button>
                </div>
                </form>`;
